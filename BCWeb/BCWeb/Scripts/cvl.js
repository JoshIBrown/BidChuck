...
jCVL_ColumnList.prototype._createColumns = function () {
    ...
    for (var i = 0; i < this.opts.columnNum; i++) {
        ...
        var col = new jCVL_Column({
            ...
            onClick: (function (colIndex) {
                return function (ev, index, item) {
                    that.onColumnItemClick(ev, colIndex, index, item);
                };
            })(i),
            onCheckboxClick: (function (colIndex) {
                return function (ev, index, item) {
                    that.onColumnItemCheckboxClick(ev, colIndex, index, item);
                };
            })(i),
            onColumnClick: (function (colIndex) {
                return function (ev) {
                    that.onColumnClick(ev, colIndex);
                };
            })(i),
            textFormat: this.opts.textFormat,
            childrenCounterFormat: this.opts.childrenCounterFormat,
