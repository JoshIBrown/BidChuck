var scopePicker = angular.module('ScopePickerDirective', []);
scopePicker.directive('bcScopePicker', ['$http', function ($http) {
    ...
    function link(scope, element, attrs) {
        ...
        scope.removeTag = function (data) {
            ...
            angular.forEach(scope.availableScopes, function (v, k) {
                if (v.Id === data.Id) {
                    scope = v;
                }
            });
    ...
    return {
        templateUrl: '/AngularTemplate/ScopePicker',
        restrict: 'E',
        scope: { availableScopes: "=availableScopes", selectedScopes: "=selectedScopes" },
        link: link
    };
}]);