...
angular.element(document).ready(function () {
    var app = angular.module('editProject', ['filters']);

    app.controller('EditProjectCtrl', ['$scope', '$http', '$window', function ($scope, $http, $window) {
        'use strict';
        ...
        $http.get('/api/Scopes/GetScopesToManage/?type=project&ident=' + $scope.projectId)
    ...
    angular.bootstrap(document, ['editProject']);
});